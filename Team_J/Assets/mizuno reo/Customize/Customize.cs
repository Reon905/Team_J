...
public class Customize : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (Money.Instance.DayMoney < 3000)
        {
            CarStage = 0;
        ...
        else if (Money.Instance.DayMoney >= 3000 && Money.Instance.DayMoney < 4000)
        {
            CarStage = 1;
        ...
        else if (Money.Instance.DayMoney >= 4000 && Money.Instance.DayMoney < 5000)
        {
            CarStage = 2;
        ...
        else if (Money.Instance.DayMoney >= 5000 && Money.Instance.DayMoney < 6000)
        {
            CarStage = 3;
        ...
        else if (Money.Instance.DayMoney >= 6000 && Money.Instance.DayMoney < 8000)
        {
            CarStage = 4;
        ...
        else if (Money.Instance.DayMoney >= 8000 && Money.Instance.DayMoney < 10000)
        {
            CarStage = 5;
        ...
        else if (Money.Instance.DayMoney >= 10000 && Money.Instance.DayMoney < 20000)
        {
            CarStage = 6;
        ...
        else if (Money.Instance.DayMoney >= 30000 && Money.Instance.DayMoney < 40000)
        {
            CarStage = 8;
        ...
        else if (Money.Instance.DayMoney >= 40000 && Money.Instance.DayMoney < 60000)
        {
            CarStage = 9;
        ...
        else if (Money.Instance.DayMoney >= 60000 && Money.Instance.DayMoney < 100000)
        {
            CarStage = 10;
        ...
        else if (Money.Instance.DayMoney >= 100000 && Money.Instance.DayMoney < 120000)
        {
            CarStage = 11;
        ...
        else if (Money.Instance.DayMoney >= 150000 && Money.Instance.DayMoney < 230000)
        {
            CarStage = 13;
        ...
        else if (Money.Instance.DayMoney >= 230000 && Money.Instance.DayMoney < 350000)
        {
            CarStage = 14;
        ...
        else if (Money.Instance.DayMoney >= 350000 && Money.Instance.DayMoney < 400000)
        {
            CarStage = 15;
        ...
        else if (Money.Instance.DayMoney >= 400000 && Money.Instance.DayMoney < 450000)
        {
            CarStage = 16;
        ...
        else if (Money.Instance.DayMoney >= 450000 && Money.Instance.DayMoney < 500000)
        {
            CarStage = 17;
        ...
        else if (Money.Instance.DayMoney >= 550000 && Money.Instance.DayMoney < 600000)
        {
            CarStage = 19;
        ...
        else if (Money.Instance.DayMoney >= 600000 && Money.Instance.DayMoney < 700000)
        {
            CarStage = 20;
            selectedAcceleration = 8.8f;
            selectedMaxSpeed = 58f;
        ...
        else if (Money.Instance.DayMoney >= 700000 && Money.Instance.DayMoney < 750000)
        {
            CarStage = 21;
        ...
        else if (Money.Instance.DayMoney >= 750000 && Money.Instance.DayMoney < 800000)
        {
            CarStage = 22;
        ...
        else if (Money.Instance.DayMoney >= 800000 && Money.Instance.DayMoney < 850000)
        {
            CarStage = 23;
        ...
        else if (Money.Instance.DayMoney >= 850000 && Money.Instance.DayMoney < 900000)
        {
            CarStage = 24;
        ...
        else if (Money.Instance.DayMoney >= 900000 && Money.Instance.DayMoney < 950000)
        {
            CarStage = 25;
            selectedAcceleration = 9.6f;
            selectedMaxSpeed = 66f;
        ...
        else if (Money.Instance.DayMoney >= 950000 && Money.Instance.DayMoney < 1000000)
        {
            CarStage = 26;
        ...
        else if (Money.Instance.DayMoney >= 1000000)
        {
            CarStage = 27;
