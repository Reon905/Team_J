...
public class Reduction : MonoBehaviour
{
    ...
    public void ReduceAll()
    {
        ...
        Item.totalMoney = Mathf.FloorToInt(Item.totalMoney * 0.8f);
        Item.totalPoints = Mathf.FloorToInt(Item.totalPoints * 0.8f);
        ...
        Item2.totalMoney = Mathf.FloorToInt(Item2.totalMoney * 0.8f);
        Item2.totalPoints = Mathf.FloorToInt(Item2.totalPoints * 0.8f);
        ...
        Item3.totalMoney = Mathf.FloorToInt(Item3.totalMoney * 0.8f);
        Item3.totalPoints = Mathf.FloorToInt(Item3.totalPoints * 0.8f);
        ...
        Item4.totalMoney = Mathf.FloorToInt(Item4.totalMoney * 0.8f);
        Item4.totalPoints = Mathf.FloorToInt(Item4.totalPoints * 0.8f);
        ...
        Item5.totalMoney = Mathf.FloorToInt(Item5.totalMoney * 0.8f);
        Item5.totalPoints = Mathf.FloorToInt(Item5.totalPoints * 0.8f);
        ...
        Item6.totalMoney = Mathf.FloorToInt(Item6.totalMoney * 0.8f);
        Item6.totalPoints = Mathf.FloorToInt(Item6.totalPoints * 0.8f);
        ...
        Item7.totalMoney = Mathf.FloorToInt(Item7.totalMoney * 0.8f);
        Item7.totalPoints = Mathf.FloorToInt(Item7.totalPoints * 0.8f);
        ...
        Item8.totalMoney = Mathf.FloorToInt(Item8.totalMoney * 0.8f);
        Item8.totalPoints = Mathf.FloorToInt(Item8.totalPoints * 0.8f);
        ...
        Item9.totalMoney = Mathf.FloorToInt(Item9.totalMoney * 0.8f);
        Item9.totalPoints = Mathf.FloorToInt(Item9.totalPoints * 0.8f);
        ...
        Item10.totalMoney = Mathf.FloorToInt(Item10.totalMoney * 0.8f);
        Item10.totalPoints = Mathf.FloorToInt(Item10.totalPoints * 0.8f);
        ...
        Item11.totalMoney = Mathf.FloorToInt(Item11.totalMoney * 0.8f);
        Item11.totalPoints = Mathf.FloorToInt(Item11.totalPoints * 0.8f);
